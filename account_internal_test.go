...
func TestUnmarshalAccount(t *testing.T) {
	tests := []struct {
		...
		{
			name:  "MissingCrypto",
			input: []byte(`{"id":"c9958061-63d4-4a80-bcf3-25f3dda22340","name":"test account","pubkey":"a99a76ed7796f7be22d5b7e85deeb7c5677e88e511e0b337618f8c4eb61349b4bf2d153f649f7b53359fe8b94a38e44c","version":4}`),
			err:   errors.New("account crypto missing"),
		},
		{
			name:  "BadCrypto",
			input: []byte(`{"id":"c9958061-63d4-4a80-bcf3-25f3dda22340","name":"test account","pubkey":"a99a76ed7796f7be22d5b7e85deeb7c5677e88e511e0b337618f8c4eb61349b4bf2d153f649f7b53359fe8b94a38e44c","version":4,"crypto":2}`),
